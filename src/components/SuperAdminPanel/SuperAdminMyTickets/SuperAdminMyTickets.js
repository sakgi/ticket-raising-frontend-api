...
// import { getFirestore, collection, doc, getDocs } from 'firebase/firestore'; // Import Firestore methods
...
//           const ticketDetailsRef = collection(db, `TicketList`); // Reference to the user's TicketDetails subcollection
//           const ticketSnapshot = await getDocs(ticketDetailsRef); // Fetch the tickets

//           const userTickets = ticketSnapshot.docs.map((doc) => ({
//             id: doc.id,
//             ...doc.data(),
...
//               <th>ID</th>
//               <th>Subject</th>
//               <th>Date</th> {/* Updated column title */}
//               <th>Priority</th>
//               <th>Status</th>
//               <th>Raised Time</th>
//               <th>Actions</th>
...
//                 <td>{formatDate(ticket.createdAt)}</td> {/* Display formatted date */}
